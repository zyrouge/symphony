...
module.exports = class {
    ...
    static async getVersion() {
        ...
        return {
            versionCode: this.versionCodeRegex.exec(content)[1],
    ...
    static async updateVersion({ versionCode, versionName }) {
        ...
        content.replace(this.versionCodeRegex, `versionCode ${versionCode}`);
        content.replace(this.versionNameRegex, `versionName "${versionName}"`);
