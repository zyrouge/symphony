...
@Dao
abstract class ComposerSongMappingStore {
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    abstract suspend fun upsert(vararg entities: ComposerSongMapping)
    ...
    fun findTop4SongArtworksAsFlow(composerId: String): Flow<List<SongArtworkIndex>> {
