...
This project uses [Phrasey](https://github.com/zyrouge/phrasey) for i18n. Follow the install
instructions and run `npm run prebuild` at the root folder before running the app.
